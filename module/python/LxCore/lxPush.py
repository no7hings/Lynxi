...
version = '1.0.0.1'
#
lynxiVersion = lxConfigure.PythonVersion()

Path_Develop_Python_Source = lxConfigure.PythonModuleBranch().developDirectory()
Path_Develop_Icon = lxConfigure.IconSubRoot().developDirectory()
File_Develop_Version_File = lynxiVersion.developFile()
#
Path_Product_Python_Source = lxConfigure.PythonModuleBranch().productDirectory()
Path_Product_Python_Compile = lxConfigure.PythonCompileBranch().productDirectory()
Path_Product_Icon = lxConfigure.IconSubRoot().productDirectory()
...
def setPythonVersion(version_):
    ...
    lxConfigure.PythonVersion()._upload(version_)
