...
#
class UiLayoutViewModel(uiModelBasic._UiViewModelBasic):
    Fixed = 0
    Minimum = 1
    Maximum = 4
    Preferred = 5
...
#
class UiScrollAreaModel(uiModelBasic._UiScrollAreaModelBasic):
    def __init__(self, widget):
        self._initScrollAreaBasic(widget)


#
class UiPresetViewModel(uiModelBasic._UiViewModelBasic):
    def __init__(self, widget):
        self._initViewModelBasic(widget)
        #
    ...
    def __overrideItemAttr(self):
        self._itemMode = uiCore.TreeMode
...
#
class UiTreeViewModel(uiModelBasic._UiViewModelBasic):
    def __init__(self, widget):
        self._initViewModelBasic(widget)
        #
        self.__overrideItemAttr()
...
#
class UiCheckAreaModel(uiModelBasic._UiViewModelBasic):
    def __init__(self, widget):
        self._initViewModelBasic(widget)
        #
        self.__overrideItemAttr()
    #
    def __overrideItemAttr(self):
        self._itemMode = uiCore.FormMode
...
#
class UiGridViewModel(uiModelBasic._UiViewModelBasic):
    def __init__(self, widget):
        self._initViewModelBasic(widget)
        #
        self.__overrideAttr()
    ...
    def __overrideAttr(self):
        ...
        #
        self._itemMode = uiCore.IconMode
        #
    ...
    def setListModeEnable(self, boolean):
        self._itemMode = [uiCore.IconMode, uiCore.ListMode][boolean]
    #
    def isMaximum(self):
