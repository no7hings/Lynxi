...
#
class UiToolGroupBoxModel(uiModelBasic.UiGroupModelBasic):
    ...
    def _overrideAttr(self):
        ...
        self.setUnexpandedSizePolicy(uiCore.QSizePolicy.Expanding, uiCore.QSizePolicy.Fixed)
    #
...
#
class UiToolBoxModel(uiModelBasic.UiGroupModelBasic):
    def __init__(self, widget):
        self._initGroupModelBasic(widget)
        self._overrideAttr()
    #
    ...
    def setViewportLayout(self, widget):
        if hasattr(widget, '_viewportLayout'):
            ...
            self._viewportLayout = uiCore.QGridLayout(self._viewport)
        #
        self._viewportLayout.setAlignment(uiCore.QtCore.Qt.AlignTop)
...
#
class UiButtonTabBarModel(uiModelBasic._UiTabBarModelBasic):
    def __init__(self, widget):
        self._initTabBarModelBasic(widget)


# Tab Bar
class UiShelfTabBarModel(uiModelBasic._UiTabBarModelBasic):
    def __init__(self, widget):
        self._initTabBarModelBasic(widget)
        #
        self.__overrideAttr()
...
# Tab View
class UiButtonTabGroupModel(uiModelBasic._UiTabGroupModelBasic):
    def __init__(self, widget):
        self._initTabViewModelBasic(widget)


#
class UiShelfTabGroupModel(uiModelBasic._UiTabGroupModelBasic):
    def __init__(self, widget):
        self._initTabViewModelBasic(widget)
    #
    ...
    def setWidget(self, widget):
        ...
        self._scrollSubTimer, self._scrollAddTimer = uiCore.QtCore.QTimer(self._widget), uiCore.QtCore.QTimer(self._widget)
    #
