...
#
from LxUi.qt.uiModels import uiItemModel
...
#
class UiMessageWidget(uiCore.QWidget):
    TextMessageType = 0
    IconMessageType = 1
    ImageType = 2
    ImageExplainType = 3
    ...
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(UiMessageWidget, self)
    ...
    def paintEvent(self, event):
        ...
        if self._messages:
            for drawAction, drawData in self._messages:
                ...
                # Text
                    ...
                    painter.setFont(
                        uiCore.xFont(size=8, weight=50, italic=italic, family=_families[0])
                    )
                ...
                # Image1
                    ...
                    if image is not None:
                        ...
                        painter.setDrawImage(_placeholderRect, uiCore._toLxOsIconFile('svg_basic@svg#empty'))
                    #
                    painter.setBackgroundRgba(72, 72, 72, 0)
                    painter.setBorderRgba(self._uiBorderRgba)
                        ...
                        if self._leftTextRect is not None:
                            ...
                            if textDrawData is not None:
                                ...
                                if italic is True:
                                    painter.setBorderRgba((95, 95, 95, 255))
                                painter.setFont(
                                    uiCore.xFont(size=12, weight=70, italic=italic, family=_families[0])
                                )
        ...
        if self._topTextRect is not None:
            ...
            if textDrawData is not None:
                ...
                # noinspection PyArgumentEqualDefault
                painter.setFont(
                    uiCore.xFont(size=8, weight=50, italic=italic, family=_families[1])
                )
                painter.drawText(rect, option, string)
        # Image Button
            ...
            for messageType, uiData in messages:
                ...
                # Icon + Text
                    ...
                    if iconKeyword is None:
                        lis.append((
                            self.DrawIcon,
                            (iconRect, uiCore._toLxOsIconFile('svg_basic@svg#unused'))
                        ))
                    else:
                        ...
                        lis.append((
                            self.DrawIcon,
                            (iconRect, uiCore._toLxOsIconFile(iconKeyword))
                        ))
                    # State
                    if iconState is not None:
                        ...
                        lis.append((
                            self.DrawIcon,
                            (subIconRect, uiCore._toLxOsIconFile('state@svg#{}'.format(iconState)))
                        ))
                    #
    ...
    def initUi(self):
        ...
        # noinspection PyArgumentEqualDefault
        self.setFont(
            uiCore.xFont(size=8, weight=50, family=_families[2])
        )
        #
...
#
class UiFilterCheckbutton(uiWidgetBasic._UiItemBasic):
    itemSize = 20, 20
    ...
    def paintEvent(self, event):
        ...
        if self.itemModel()._uiNameText is not None:
            ...
            # noinspection PyArgumentEqualDefault
            painter.setFont(
                uiCore.xFont(size=8, weight=50, italic=self._uiFontItalic, family=_families[0])
            )
            textOption = QtCore.Qt.AlignLeft | QtCore.Qt.AlignVCenter
            painter.drawText(
    ...
    #
    def setupUi(self):
        self._itemModel = uiItemModel.UiFilterCheckItemModel(self)


#
class UiCheckbutton(uiWidgetBasic._UiItemBasic):
    def __init__(self, iconKeyword=None, *args, **kwargs):
        self.clsSuper = super(uiCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
    ...
    #
    def setupUi(self):
        self._itemModel = uiItemModel.UiCheckItemModel(self)


#
class UiRadioCheckbutton(uiWidgetBasic._UiItemBasic):
    def __init__(self, iconKeyword=None, *args, **kwargs):
        self.clsSuper = super(uiCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
...
#
class UiEnableButton(uiWidgetBasic._UiItemBasic):
    def __init__(self, iconKeyword=None, *args, **kwargs):
        self.clsSuper = super(uiCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
    ...
    #
    def setupUi(self):
        self._itemModel = uiItemModel.UiEnableItemModel(self)


#
class UiValueEnterlabel(uiWidgetBasic._UiValueEnterlabelBasic):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(uiCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
...
#
class UiFilterEnterlabel(uiWidgetBasic._UiFilterEnterlabelBasic):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(uiCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
...
#
class UiEnterlabel(uiWidgetBasic._UiDatumEntryItemBasic):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(uiCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
...
#
class UiEnterbox(uiWidgetBasic._UiDatumEntryItemBasic):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(uiCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
...
#
class UiIconbutton(uiWidgetBasic._UiIconbuttonBasic):
    def __init__(self, iconKeyword=None, *args, **kwargs):
        self.clsSuper = super(uiCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
...
#
class UiMenuIconbutton(uiWidgetBasic._UiMenuIconbuttonBasic):
    def __init__(self, iconKeyword=None, *args, **kwargs):
        self.clsSuper = super(uiCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
...
#
class UiPressbutton(uiWidgetBasic._UiItemBasic):
    def __init__(self, iconKeyword=None, *args, **kwargs):
        self.clsSuper = super(uiCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
    ...
    #
    def setupUi(self):
        self._itemModel = uiModelBasic.UiPressbuttonModel(self)


#
class UiTreeItem(uiWidgetBasic._UiTreeItemBasic):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(uiCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
...
#
class UiGridItem(uiWidgetBasic._UiItemBasic):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(uiCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
    ...
    def paintEvent(self, event):
        painter = uiCore.QPainter_(self)
        # noinspection PyArgumentEqualDefault
        painter.setFont(uiCore.xFont(size=8, weight=50, italic=False, family=_families[0]))
        # Shadow
        if self.itemModel()._itemMode is uiCore.IconMode:
    ...
    #
    def setupUi(self):
        self._itemModel = uiItemModel.UiGridItemModel(self)
        #
        self._layout = uiCore.QGridLayout_(self)
...
#
class UiPresetItem(uiWidgetBasic._UiItemBasic):
    indexChanged = uiCore.uiSignal()
    setChanged = uiCore.uiSignal()
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(uiCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
    ...
    #
    def setupUi(self):
        self._itemModel = uiItemModel.UiPresetItemModel(self)
        #
        self._descriptionLabel = UiEnterlabel()
...
#
class UiRecordItem(uiWidgetBasic._UiItemBasic):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(uiCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
    ...
    #
    def setupUi(self):
        self._itemModel = uiItemModel.UiRecordItemModel(self)


#
class UiTextBrower(uiWidgetBasic._UiTextBrowerBasic):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(uiCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
