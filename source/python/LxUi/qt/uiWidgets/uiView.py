...
#
from LxUi.qt.uiModels import uiViewModel
#
QtGui = uiCore.QtGui
...
#
class UiScrollArea(uiCore.QWidget):
    scrollWidth = 20
    ...
    #
    def setupUi(self):
        self._viewport = uiCore.QWidget(self)
        #
        self._vScrollBar, self._hScrollBar = uiWidgetBasic.UiScrollBar(self), uiWidgetBasic.UiScrollBar(self)
        #
        self._layout = uiCore.QVBoxLayout_(self._viewport)
        self._layout.setContentsMargins(0, 0, 0, 0)
        self._layout.setSpacing(0)
        self._layout.setAlignment(QtCore.Qt.AlignTop)
        #
        self._viewModel = uiViewModel.UiScrollAreaModel(self)


#
class UiCheckView(uiWidgetBasic._UiViewBasic):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(uiCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
    ...
    #
    def setupUi(self):
        self._viewModel = uiViewModel.UiCheckAreaModel(self)


#
class UiTreeView(uiWidgetBasic._UiViewBasic):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(uiCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
    ...
    #
    def setupUi(self):
        self._hScrollBar = uiWidgetBasic.UiScrollBar(self)
        self._vScrollBar = uiWidgetBasic.UiScrollBar(self)
        #
        self._viewModel = uiViewModel.UiTreeViewModel(self)
        #
        self._uiPreActions = [
            ('Check',),
...
#
class UiGridView(uiWidgetBasic._UiViewBasic):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(uiCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
    ...
    def _setUiPressStyle(self, state):
        if state == uiCore.NormalState:
            self._uiBackgroundRgba = 0, 0, 0, 0
            self._uiBorderRgba = 0, 0, 0, 0
        elif state == uiCore.OnState:
            self._uiBackgroundRgba = 0, 0, 0, 0
    ...
    def setupUi(self):
        ...
        self._vScrollBar = uiWidgetBasic.UiScrollBar(self)
        #
        self._viewModel = uiViewModel.UiGridViewModel(self)
        #
        self._uiPreActions = [
            ('Basic', ),
            (
...
# Preset
class UiPresetView(uiWidgetBasic._UiViewBasic):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(uiCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
    ...
    def setupUi(self):
        ...
        self._vScrollBar = uiWidgetBasic.UiScrollBar(self)
        #
        self._viewModel = uiViewModel.UiPresetViewModel(self)
        #
        self._uiPreActions = [
            ('Check',),
            ('Check All#Ctrl + A', 'svg_basic@svg#checkedAll', self._viewModel.isCheckEnable, self._viewModel.setCheckAll),
