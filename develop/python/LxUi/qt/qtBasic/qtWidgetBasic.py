...
# Basic Item
class _QtItemBasic(qtCore.QWidget):
    ...
    #
    def setupUi(self):
        self._itemModel = qtModelBasic._QtItemModel(self)


# Basic View
class _QtViewBasic(qtCore.QWidget):
    clicked = qtCore.uiSignal()
    ...
    #
    def setupUi(self):
        self._viewModel = qtModelBasic._QtViewModel(self)


# Window Basic
class _QtWindowBasic(qtCore.QMainWindow):
    ...
    def setupUi(self):
        ...
        #
        self._viewModel = qtModelBasic.QtWindowModel(self)
        #
...
#
class _QtSeparateWindow(_QtWindowBasic):
...
#
class _QtChartBasic(qtCore.QWidget):
...
#
class _QtTreeviewItemBasic(_QtItemBasic):
    ...
    #
    def setupUi(self):
        self._itemModel = qtModelBasic.QtTreeviewItemModel(self)
...
class QtScrollBar(qtCore.QWidget):
    ...
    def setupUi(self):
        ...
        #
        self._viewModel = qtModelBasic.QtScrollBarModel(self)


#
class _QtIconbuttonBasic(_QtItemBasic):
    ...
    #
    def setupUi(self):
        self._itemModel = qtModelBasic.QtIconbuttonModel(self)
        #
        self.actionData = []


#
class QtIconbutton(_QtIconbuttonBasic):
...
#
class _QtMenuIconbuttonBasic(_QtItemBasic):
    @qtCore.uiTooltipClearMethod
    def mousePressEvent(self, event):
        if event.button() == QtCore.Qt.LeftButton:
            self.itemModel()._pressStartAction(event)
...
#
class QtMenuIconbutton(_QtMenuIconbuttonBasic):
    def __init__(self, iconKeyword=None, *args, **kwargs):
        self.clsSuper = super(qtCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
...
#
class _QtValueEnterlabelBasic(qtCore.QWidget):
    def _initItemBasic(self):
        self.setSizePolicy(
    ...
    #
    def setupUi(self):
        self._itemModel = qtModelBasic.QtValueEnterItemModel(self)
        self._itemModel.setEnterWidgetClass(QLineEdit_)


#
class _QtFilterEnterlabelBasic(qtCore.QWidget):
    entryChanged = qtCore.uiSignal()
    def _initItemBasic(self):
        self.setSizePolicy(
    ...
    def readHistory(self):
        filterHistoryFile = lxConfigure.UserPreset().uiFilterHistoryFile()
    ...
    def setupUi(self):
        ...
        #
        self._itemModel = qtModelBasic.QtFilterEnterItemModel(self)
        #
...
#
class QtFilterEnterlabel(_QtFilterEnterlabelBasic):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(qtCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
...
#
class _QtEnterlabelBasic(_QtItemBasic):
    entryChanged = qtCore.uiSignal()
    ...
    def setupUi(self):
        ...
        #
        self._itemModel = qtModelBasic.QtEnterItemModel(self)
        #
...
#
class _QtChooseItem(_QtItemBasic):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(qtCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
...
#
class _QtChooseView(_QtViewBasic):
    def __init__(self, *args, **kwargs):
    ...
    def setupUi(self):
        ...
        #
        self._viewModel = qtModelBasic.QtChooseViewModel(self)
...
class _QtChooseDropView(qtCore.QWidget):
    ...
    def setupUi(self):
        ...
        #
        self._viewModel = qtModelBasic.QtChooseDropViewModel(self, _QtChooseItem)
...
class _QtActionItem(qtCore.QWidget):
    ...
    def setupUi(self):
        ...
        #
        self._itemModel = qtModelBasic.QtActionItemModel(self)
...
class _QtActionDropView(qtCore.QWidget):
    ...
    def setupUi(self):
        ...
        #
        self._viewModel = qtModelBasic.QtActionDropViewModel(self, _QtActionItem)


#
class QtAttributeItem(_QtItemBasic):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(qtCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
    ...
    #
    def setupUi(self):
        self._itemModel = qtModelBasic.QtAttributeItemModel(self)
...
class _QtTabBasic(qtCore.QWidget):
    ...
    def setupUi(self):
        ...
        #
        self._itemModel = qtModelBasic.QtTabModel(self)
...
class QtButtonTab(_QtTabBasic):
    ...
    def setupUi(self):
        ...
        self._closeButton.setIcon('svg_basic@svg#closeTab', 8, 8, 10, 10)
        #
        self._itemModel = qtModelBasic.QtButtonTabModel(self)
...
class QtShelfTab(_QtTabBasic):
    ...
    def setupUi(self):
        ...
        self._closeButton.setIcon('svg_basic@svg#closeTab', 8, 8, 10, 10)
        #
        self._itemModel = qtModelBasic.QtShelfTabModel(self)
...
class QtChooseTab(qtCore.QWidget):
    ...
    def setupUi(self):
        ...
        self._chooseButton.clicked.connect(self._chooseDropAction)
        #
        self._itemModel = qtModelBasic.QtChooseTabModel(self)
        #
        self._chooseButton.upScrolled.connect(self._itemModel._chooseScrollUpAction)
        self._chooseButton.downScrolled.connect(self._itemModel._chooseScrollDownAction)
...
#
class _QtTabBarBasic(qtCore.QWidget):
    # Scroll
    valueChanged = qtCore.uiSignal()
    stop = qtCore.uiSignal()
    # Click
    ...
    #
    def setupUi(self):
        self._viewModel = qtModelBasic.QtTabBarModel(self)


#
class _QtTabBar(_QtTabBarBasic):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(qtCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
...
# Tab View
class _QtTabGroupBasic(qtCore.QWidget):
    currentChanged = qtCore.uiSignal()
    ...
    def setupUi(self):
        ...
        #
        self._viewModel = qtModelBasic.QtTabGroupModel(self)


# Group
class _QtGroupBasic(qtCore.QWidget):
    expanded = qtCore.uiSignal()
    ...
    def setupUi(self):
        ...
        self._groupModel = qtModelBasic.QtGroupModel(self)


#
class _QtTextBrowerBasic(qtCore.QWidget):
    entryChanged = qtCore.uiSignal()
    #
    counterWidth = 32
    menuHeight = 24
    ...
    def setupUi(self):
        ...
        #
        self._itemModel = qtModelBasic.QtTextBrowerItemModel(self)
        #
...
#
class QtTextBrower(_QtTextBrowerBasic):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(qtCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
