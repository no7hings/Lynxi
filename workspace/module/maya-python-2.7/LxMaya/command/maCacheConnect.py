...
class LxAstModelCacheConnectMethod(object):
    ...
    def _setShapeBlendCmd(self, sourceObjectPath, targetObjectPath, visibility):
        sourceShapePath = maUtils._dcc_getNodShapeNodepathStr(sourceObjectPath)
        ...
        #
        targetShapePath = maUtils._dcc_getNodShapeNodepathStr(targetObjectPath)
    ...
    def _setBlendResultClear(cls, targetObjectPath):
        shapePath = maUtils._dcc_getNodShapeNodepathStr(targetObjectPath)
