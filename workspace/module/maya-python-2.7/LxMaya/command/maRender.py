...
def getRenderableCameraLis(fullPath=True):
    ...
    for camera in cameras:
        ...
        if renderable:
            transformPath = maUtils._dcc_getNodTransformNodepathStr(camera, fullPath=fullPath)
...
def setRenderCamera(filterCameras):
    ...
    for shapePath in cameraShapes:
        ...
        transformPath = maUtils._dcc_getNodTransformNodepathStr(shapePath)
...
def getAiLightDecays(lightObjectPath):
    shape = maUtils._dcc_getNodShapeNodepathStr(lightObjectPath)
