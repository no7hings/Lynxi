...
def makePreview(
    ...
    maCam.setCameraView(maUtils._dcc_getNodShapeNodepathStr(camera), displayResolution, displaySafeTitle)
    ...
    # Image Preview
    maCam.setCameraCloseHud()
    # maCam.setCameraView(maUtils._dcc_getNodShapeNodepathStr(camera))
