...
#
class IfAstModelCharToolUnit(kitQtWgtAbs.IfToolUnitBasic):
    UnitConnectLinks = [
    ...
    VAR_kit__qt_wgt__unit__uiname = 'Model ( Character ) Tool Unit'
    VAR_kit__qt_wgt__unit__icon = 'window/charToolPanel'
    VAR_kit__qt_wgt__unit__tip = u'''模型角色工具模块'''
    ...
    def _initObjectPathDic(self):
        ...
        if self.connectObject() is not None:
            ...
            dic = bscMethods.MaNodeString.covertToPathCreateDic(hierarchyData)
            self._objectPathDic.update(dic)
            #
            subHierarchyData = assetPr.astModelSolverHierarchyConfig(assetName)
            subDic = bscMethods.MaNodeString.covertToPathCreateDic(subHierarchyData)
        ...
        def addGeometryObjectCmd(keyword):
            if self.connectObject() is not None:
                ...
                if parentName in self._objectPathDic:
                    ...
                    if not maUtils._isAppExist(parentPath):
    ...
    def _updateBtnStateCmd(self):
        ...
        for k, v in uiData.items():
            ...
            if groupName in self._objectPathDic:
                ...
                #
                boolean = maUtils._isAppExist(groupPath)
                ...
                if boolean is True:
                    ...
                    if subBoolean is True:
                        childNames = [maUtils._nodeString2nodename_(i) for i in childObjects]
                        button.setTooltip('\r\n'.join(childNames[:10]))
    ...
    def _kit__unit__set_build_Widgets(self):
        self._upToolUiBox = guiQtWidgets.QtToolbox()
        ...
        #
        self._downToolUiBox = guiQtWidgets.QtToolbox()
...
#
class IfAstModelToolUnit(kitQtWgtAbs.IfToolUnitBasic):
    UnitConnectLinks = [
        prsMethods.Asset.modelLinkName()
    ]
    VAR_kit__qt_wgt__unit__uiname = 'Model Tool Unit'
    VAR_kit__qt_wgt__unit__icon = 'window/modelToolPanel'
    VAR_kit__qt_wgt__unit__tip = u'''模型工具模块'''
    #
    widthSet = 400
    ...
    ToolLayoutDic_AstModelRepair = dict(
        ...
        astRepairMesh=[1, 3, 0, 1, 4, 'Repair Mesh', 'svg_basic/mesh'],
        # 4
        withMaterial=[1, 5, 0, 1, 2, 'Material'], withTexture=[1, 5, 2, 1, 2, 'Texture'],
        withAov=[1, 6, 0, 1, 2, 'AOV'],
        repairShader=[1, 7, 0, 1, 4, 'Repair Nde_ShaderRef', 'svg_basic/shader']
    )
    #
    ToolLayoutDic_AstModelUtils = {
        'addSolverHierarchy': [1, 0, 0, 1, 2, 'Add Solver Hierarchy', 'svg_basic/addtab'], 'addReferenceHierarchy': [1, 0, 2, 1, 2, 'Add Reference Hierarchy', 'svg_basic/addtab'],
        # 1
        'collectionReferenceObject': [1, 2, 0, 1, 4, 'Collection Reference Object(s)', 'svg_basic/addtab']
    }
    def __init__(self, *args, **kwargs):
    ...
    def setupAstModelRepairToolUiBox(self, toolBox):
        ...
        #
        self.withTransformationButton = guiQtWidgets.QtCheckbutton()
        ...
        #
        self.withUnlockNormalButton = guiQtWidgets.QtCheckbutton()
        ...
        self.withSoftNormalButton = guiQtWidgets.QtCheckbutton()
        ...
        #
        self.withUvButton = guiQtWidgets.QtCheckbutton()
        ...
        #
        self.withHistoryButton = guiQtWidgets.QtCheckbutton()
        ...
        #
        self._modelMeshRepairButton = guiQtWidgets.QtPressbutton()
        ...
        #
        self.withMaterialButton = guiQtWidgets.QtCheckbutton()
        ...
        #
        self.withAovButton = guiQtWidgets.QtCheckbutton()
        ...
        #
        self._modelShaderRepairButton = guiQtWidgets.QtPressbutton()
    ...
    def setupAstModelUtilsToolUiBox(self, toolBox):
        ...
        #
        self._addModelSolverHierarchyButton = guiQtWidgets.QtPressbutton()
        ...
        #
        self._addModelReferenceHierarchyButton = guiQtWidgets.QtPressbutton()
        ...
        #
        self._collectionReferenceObjectButton = guiQtWidgets.QtPressbutton()
    ...
    def setCollectionReferenceObjectCmd(self):
        ...
        if not maUtils._isAppExist(astUnitModelReferenceGroup):
    ...
    #
    def _kit__unit__set_build_Widgets(self):
        self._repairToolBox = guiQtWidgets.QtToolbox()
        ...
        #
        self._utilitiesToolBox = guiQtWidgets.QtToolbox()
...
#
class IfAstRigToolUnit(kitQtWgtAbs.IfToolUnitBasic):
    UnitConnectLinks = [
        prsMethods.Asset.rigLinkName()
    ]
    VAR_kit__qt_wgt__unit__uiname = 'Rig Tool Unit'
    VAR_kit__qt_wgt__unit__icon = 'window/rigToolPanel'
    VAR_kit__qt_wgt__unit__tip = u'''绑定工具模块'''
    #
    widthSet = 400
    #
...
#
class IfAstCfxGroomToolUnit(kitQtWgtAbs.IfToolUnitBasic):
    UnitConnectLinks = [
        prsMethods.Asset.groomLinkName(),
        prsMethods.Asset.solverLinkName()
    ]
    VAR_kit__qt_wgt__unit__uiname = 'Character FX Tool Unit'
    VAR_kit__qt_wgt__unit__icon = 'window/cfxToolPanel'
    VAR_kit__qt_wgt__unit__tip = u'''角色特效工具模块'''
    #
    ...
    ToolLayoutDic_AstCfxGraph = dict(
        ...
        childNode=[0, 1, 0, 1, 3, u'Nde_Node ( Yeti / Pfx Hair / Nurbs Hair )...'], addNode=[0, 1, 3, 1, 1, 'Add Nde_Node', 'svg_basic/addtab'],
        # 2
    ...
    ToolLayoutDic_AstCfxUtils = dict(
        growSourceSearch=[0, 0, 0, 1, 2, none], createGrowSource=[0, 0, 2, 1, 2, 'Create Source ( Grow )', 'svg_basic/addtab'],
        tips=[0, 1, 0, 1, 4, none],
        # 2
        placeholder=[1, 3, 0, 1, 4, 'Placeholder'],
        # 4
        addGrowTarget=[1, 5, 0, 1, 2, 'Add Target', 'svg_basic/addtab'], addGrowDeform=[1, 5, 2, 1, 2, 'Add Deform', 'svg_basic/addtab'],
        addCollision=[1, 6, 0, 1, 4, 'Add Collision', 'svg_basic/addtab']
    )
    def __init__(self, *args, **kwargs):
    ...
    def setupAstCfxGraphToolUiBox(self, toolBox):
        ...
        #
        self._nodeFullNameUiLabel = guiQtWidgets.QtValueLine()
        toolBox.setInfo(inData, 'childNode', self._nodeFullNameUiLabel)
        #
        self._addNodeButton = guiQtWidgets.QtPressbutton()
        ...
        #
        self._furNodeKeywordEntryLabel = guiQtWidgets.QtValueLine()
        self._furNodeKeywordEntryLabel.setNameString(0)
    ...
    def setupAstCfxUtilsToolUiBox(self, toolBox):
        ...
        #
        self._astModelGeometryFilterLabel = guiQtWidgets.QtFilterLine()
        toolBox.setButton(inData, 'growSourceSearch', self._astModelGeometryFilterLabel)
        #
        self.createGrowSourceButton = guiQtWidgets.QtPressbutton()
        ...
        #
        self._growSourceCreateTipLabel = guiQtWidgets.QtValueLine()
        ...
        self._astModelGeometryObjectTreeViewBox.setKeywordFilterWidgetConnect(self._astModelGeometryFilterLabel)
        #
        self.addGrowTargetButton = guiQtWidgets.QtPressbutton()
        ...
        #
        self.addGrowDeformButton = guiQtWidgets.QtPressbutton()
        ...
        #
        self.addCollisionButton = guiQtWidgets.QtPressbutton()
    ...
    def setListAstCfxFur(self):
        def setListAstFurYeti(inData):
            for yetiObjectPath in inData:
                yetiObjectName = maUtils._nodeString2nodename_(yetiObjectPath)
                ...
                #
                if not maUtils._isAppExist(yetiObjectPath):
                ...
                if guideData:
                    ...
                    for guideSet, data in guideData.items():
                        setCheck = True
                        guideSetItem = qtWidgets_.QTreeWidgetItem_([maUtils._nodeString2nodename_(guideSet), 'Set'])
                        ...
                        if guideSystemData:
                            ...
                            for guideSystem in guideSystems:
                                guideSystemItem = qtWidgets_.QTreeWidgetItem_([maUtils._nodeString2nodename_(guideSystem), 'System'])
                        ...
                        if guideNucleusData:
                            ...
                            for guideNucleus in guideNuclei:
                                guideNucleusItem = qtWidgets_.QTreeWidgetItem_([maUtils._nodeString2nodename_(guideNucleus), 'Nucleus'])
        ...
        def setListAsrFurPfx(inData):
            ...
            for seq, pfxHairObjectPath in enumerate(inData):
                ...
                #
                pfxHairObjectName = maUtils._nodeString2nodename_(pfxHairObjectPath)
                ...
                # System
                if systemObjects:
                    systemGroup = assetPr.astBasicGroupNameSet(assetName, prsOutputs.Util.astPfxHairSolverNodeGroupLabel)
                    listBranch(systemObjects, pfxHairItem, 'System', 'hairSystem', objectGroup=systemGroup)
                # Nucleus
                if nucleusObjects:
                    nucleusGroup = assetPr.astBasicGroupNameSet(assetName, prsOutputs.Util.astPfxHairSolverNodeGroupLabel)
                ...
                if follicleData:
                    ...
                    if follicleObjects:
                        follicleGroup = assetPr.astBasicGroupNameSet(assetName, prsOutputs.Util.astPfxHairFollicleGroupLabel)
                        listBranch(follicleObjects, pfxHairItem, 'Follicle', 'follicle', objectGroup=follicleGroup,
                                   subRootItem=True)
                    if localCurveObjects:
                        localCurveGroup = assetPr.astBasicGroupNameSet(assetName, prsOutputs.Util.astPfxHairFollicleGroupLabel)
                    ...
                    if outputCurveObjects:
                        outputCurveGroup = assetPr.astBasicGroupNameSet(assetName, prsOutputs.Util.astPfxHairCurveGroupLabel)
                ...
                pfxHairGroup = assetPr.astBasicGroupNameSet(assetName, prsOutputs.Util.astPfxHairGroupLabel)
        ...
        self.pathDic = bscMethods.MaNodeString.covertToPathCreateDic(hierarchyData)
        #
    ...
    def setAddAstCfxFur(self):
        def setAddAstFurYeti(yetiObject, nodeLabel=none):
            ...
            if guideData:
                ...
                #
                guideFollicleSubGroup = yetiObjectName.replace(astYetiNodeGroupLabel, prsOutputs.Util.astYetiGuideFollicleGroupLabel) + prsOutputs.Util.basicGroupLabel
                #
                maUtils.setObjectAddChildGroup(guideFollicleSubGroup, guideFollicleGroup)
                #
                guideCurveGroup = assetPr.guideCurveGroupName(assetName)
                #
                guideCurveSubGroup = yetiObjectName.replace(astYetiNodeGroupLabel, prsOutputs.Util.astYetiGuideCurveGroupLabel) + prsOutputs.Util.basicGroupLabel
                #
                maUtils.setObjectAddChildGroup(guideCurveSubGroup, guideCurveGroup)
                #
                for seq, (guideSet, data) in enumerate(guideData.items()):
                    # Guide Set
                    guideSetName = yetiObjectName.replace(astYetiNodeGroupLabel, prsOutputs.Util.astYetiGuideSetNodeLabel) + '_' + str(seq + 1)
                    #
                    ...
                    for subSeq, (k, v) in enumerate(data.items()):
                        ...
                        guideCurveName = yetiObjectName.replace(
                            ...
                            prsOutputs.Util.astYetiGuideOutputCurveNodeLabel
                        ...
                        follicleName = yetiObjectName.replace(
                            astYetiNodeGroupLabel,
                            prsOutputs.Util.astYetiGuideFollicleNodeLabel
                        ) + '_' + str(seq + 1) + '_' + str(subSeq + 1)
                        #
                        ...
                        localCurveName = yetiObjectName.replace(
                            astYetiNodeGroupLabel,
                            prsOutputs.Util.astYetiGuideLocalCurveNodeLabel
                        ) + '_' + str(seq + 1) + '_' + str(subSeq + 1)
                ...
                if guideSystemData:
                    ...
                    for seq, guideSystem in enumerate(guideSystems):
                        guideSystemName = yetiObjectName.replace(astYetiNodeGroupLabel, prsOutputs.Util.astYetiGuideSystemNodeLabel) + '_' + str(seq + 1)
                ...
                if guideNucleusData:
                    ...
                    for seq, guideNucleus in enumerate(guideNuclei):
                        guideNucleusName = yetiObjectName.replace(astYetiNodeGroupLabel, prsOutputs.Util.astYetiGuideNucleusNodeLabel) + '_' + str(seq + 1)
        ...
        def setAddAstFurPfx(pfxHairObjectPath, nodeLabel=none):
            def addBranch(objects, rootName, rootNameLabel, groupNameLabel, objectNameLabel, renameShape=False, subGroup=none, hide=False, childNameLabel=none, repairShape=False, delHistory=False):
                ...
                if subGroup:
                    subGroup = nameSet + prsOutputs.Util.basicGroupLabel
                ...
                for seq, maObj in enumerate(objects):
                    ...
                    if renameShape:
                        ...
                        if maUtils._getNodeShapeCategoryString(objectName) == 'mesh':
            ...
            pfxHairObjectGroup = assetPr.astBasicGroupNameSet(assetName, prsOutputs.Util.astPfxHairGroupLabel)
            #
            ...
            if growObjects:
                addBranch(
                    growObjects, pfxHairObjectName, prsOutputs.Util.astPfxHairGroupLabel, prsOutputs.Util.astPfxHairGrowGroupLabel, prsOutputs.Util.astPfxHairGrowGroupLabel,
                    renameShape=True, subGroup=False, hide=True
                )
            # Nde_ShaderRef
            if shaders:
                for seq, shader in enumerate(shaders):
                    shaderName = pfxHairObjectName.replace(prsOutputs.Util.astPfxHairGroupLabel, prsOutputs.Util.astPfxHairShaderNodeLabel) + '_' + str(seq)
                    maUtils.setNodeRename(shader, shaderName)
            # Texture
            if textures:
                for seq, texture in enumerate(textures):
                    textureName = pfxHairObjectName.replace(prsOutputs.Util.astPfxHairGroupLabel, prsOutputs.Util.astPfxHairTextureNodeLabel) + '_' + str(seq)
                    maUtils.setNodeRename(texture, textureName)
            # Map
            if maps:
                for seq, map in enumerate(maps):
                    mapName = pfxHairObjectName.replace(prsOutputs.Util.astPfxHairGroupLabel, prsOutputs.Util.astPfxHairMapNodeLabel) + '_' + str(seq)
                    maUtils.setNodeRename(map, mapName)
            # System
            if systemObjects:
                addBranch(
                    systemObjects, pfxHairObjectName, prsOutputs.Util.astPfxHairGroupLabel, prsOutputs.Util.astPfxHairSolverNodeGroupLabel,
                    prsOutputs.Util.astPfxHairSystemNodeLabel,
                    renameShape=True, subGroup=False, hide=False)
            # Nucleus
            if nucleusObjects:
                addBranch(
                    nucleusObjects, pfxHairObjectName, prsOutputs.Util.astPfxHairGroupLabel, prsOutputs.Util.astPfxHairSolverNodeGroupLabel,
                    prsOutputs.Util.astPfxHairNucleusNodeLabel,
            ...
            if follicleData:
                ...
                if follicleObjects:
                    addBranch(
                        follicleObjects,
                        pfxHairObjectName,
                        prsOutputs.Util.astPfxHairGroupLabel,
                        prsOutputs.Util.astPfxHairFollicleGroupLabel,
                        prsOutputs.Util.astPfxHairFollicleNodeLabel,
                        renameShape=True,
                        subGroup=True,
                        hide=True,
                        childNameLabel=prsOutputs.Util.astPfxHairLocalCurveNodeLabel,
                        repairShape=True,
                ...
                if outputCurveObjects:
                    addBranch(
                        ...
                        pfxHairObjectName,
                        prsOutputs.Util.astPfxHairGroupLabel,
                        prsOutputs.Util.astPfxHairCurveGroupLabel,
                        prsOutputs.Util.astPfxHairOutputCurveNodeLabel,
                        renameShape=True,
                        subGroup=True,
                        hide=False
                    )
            ...
            def addObjectBranch(objectPath, mainGroupLabel, groupNameLabel=False, subLabelString=none, isUseLeafGroup=False):
                if maUtils._isAppExist(objectPath):
                    ...
                    if parentPath is not None:
                        ...
                        shape = maUtils._dcc_getNodShapeNodepathStr(objectPath)
                        #
            ...
            def setMain(objectPath):
                ...
                if graphObjects:
                    for seq, childObjectPath in enumerate(graphObjects):
                        addObjectBranch(
                            childObjectPath, prsOutputs.Util.astCfxFurNhrFieldGroupLabel, groupNameLabel=prsOutputs.Util.astCfxFurNhrObjectGroupLabel,
                ...
                if graphGrowGeometries:
                    for seq, childObjectPath in enumerate(graphGrowGeometries):
                        addObjectBranch(
                            childObjectPath, prsOutputs.Util.astCfxFurNhrFieldGroupLabel, groupNameLabel=prsOutputs.Util.astCfxFurNhrGrowGroupLabel,
                            subLabelString=nodeLabel + '_' + str(seq)
                        )
                #
                if graphGuideGeometries:
                    for seq, childObjectPath in enumerate(graphGuideGeometries):
                        addObjectBranch(
                            childObjectPath, prsOutputs.Util.astCfxFurNhrFieldGroupLabel, groupNameLabel=prsOutputs.Util.astCfxFurNhrGuideGroupLabel,
                            subLabelString=nodeLabel + '_' + str(seq),
                            isUseLeafGroup=True
                        )
                #
                ...
                #
                addObjectBranch(
                    objectPath, prsOutputs.Util.astCfxFurNhrFieldGroupLabel, groupNameLabel=prsOutputs.Util.astCfxFurNhrObjectGroupLabel,
    ...
    def astCreateGrowSourceCmd(self):
        def setMain():
            ...
            if meshObjectLis:
                ...
                meshName = maUtils._nodeString2nodename_(meshObject)
                #
                if not maUtils._isAppExist(objectGroupPath):
                    maUtils.setAppPathCreate(objectGroupPath)
                #
                growSourceObjectName = meshName + prsOutputs.Util.astCfxGrowSourceGroupLabel
                if not maUtils._isAppExist(growSourceObjectName):
                    maUtils.setCopyNode(meshObject, growSourceObjectName)
                    #
                    maAttr.setNodeUnrenderable(growSourceObjectName)
                    maUtils.setAttrStringDatumForce(growSourceObjectName, prsOutputs.Util.astCfxGrowSourceAttrLabel, meshName)
                    #
    ...
    def astAddGrowTargetCmd(self):
        ...
        groupName = None
        if prsMethods.Asset.isGroomStageName(assetStage):
            groupName = assetPr.astBasicGroupNameSet(assetName, prsOutputs.Util.astCfxFurGrowTargetGroupLabel)
        elif prsMethods.Asset.isSolverStageName(assetStage):
            groupName = assetPr.astBasicGroupNameSet(assetName, prsOutputs.Util.astRigSolGrowTargetGroupLabel)
        if groupName:
    ...
    def astAddGrowCollisionCmd(self):
        ...
        groupPath = None
        if prsMethods.Asset.isGroomStageName(assetStage):
            groupPath = assetPr.astBasicGroupNameSet(assetName, prsOutputs.Util.astCfxFurCollisionSubGroupLabel)
        elif prsMethods.Asset.isSolverStageName(assetStage):
            groupPath = assetPr.astBasicGroupNameSet(assetName, prsOutputs.Util.astRigSolCollisionSubGroupLabel)
        if groupPath:
            self._addObjectCmd(groupPath)
    @staticmethod
    def _addObjectCmd(groupPath):
        ...
        #
        if maUtils._isAppExist(groupPath):
    ...
    def setAddNodeBtnState(self):
        ...
        if objectPathLis:
            ...
            if selObjectPath in cfxObjects:
                ...
                #
                if selObjectPath in yetiObjects:
                    self.astFurNodeNameLabel = prsOutputs.Util.astYetiNodeGroupLabel[1:]
                elif selObjectPath in pfxHairObjects:
                    self.astFurNodeNameLabel = prsOutputs.Util.astPfxHairGroupLabel[1:]
                elif selObjectPath in nurbsHairObjects:
                    self.astFurNodeNameLabel = prsOutputs.Util.maNurbsHairNode
            else:
    ...
    def setAstFurNodeName(self):
        ...
        existNodes = []
        if furObjects:
            existNodes = [maUtils._nodeString2nodename_(i) for i in furObjects]
        #
        nodeName = var
    ...
    def setGrowSourceName(self):
        ...
        if selectedMeshes:
            ...
            growSourceMesh = meshName + prsOutputs.Util.astCfxGrowSourceGroupLabel
            boolean = not maUtils._isAppExist(growSourceMesh)
    ...
    #
    def _kit__unit__set_build_Widgets(self):
        self._astCfxHirToolUiBox = guiQtWidgets.QtToolbox()
        ...
        #
        self._astCfxUtilsToolUiBox = guiQtWidgets.QtToolbox()
...
#
class IfAstSolverToolUnit(kitQtWgtAbs.IfToolUnitBasic):
    UnitConnectLinks = [
        prsMethods.Asset.solverLinkName()
    ]
    VAR_kit__qt_wgt__unit__uiname = 'Character FX Tool Unit'
    VAR_kit__qt_wgt__unit__icon = 'window/solverToolPanel'
    VAR_kit__qt_wgt__unit__tip = u'''角色特效工具模块'''
    #
    ...
    def setupAstRigSolFurSolGuideQtToolbox(self):
        ...
        #
        self.nhrGuideObjectModifyButton = guiQtWidgets.QtPressbutton()
    ...
    def setupAstRigSolSolGuideConnectQtToolbox(self):
        ...
        #
        self.connectNurbsHairGuideButton = guiQtWidgets.QtPressbutton()
                ...
                for nhrObject in nhrObjects:
                    ...
                    if nhrGuideObjects:
                        for nhrGuideObject in nhrGuideObjects:
                            nhrGuideObjectPath = maUtils._dcc_getNodFullpathNodepathStr(nhrGuideObject)
    ...
    def nhrGuideObjectModifyCmd(self):
        def setMain():
            ...
            if nhrObjects:
                nhrGuideGroup = assetPr.astUnitRigSolNhrGuideObjectGroupName(assetName)
                for nhrObject in nhrObjects:
                    nhrObjectName = maUtils._nodeString2nodename_(nhrObject)
                    nhrGuideObjects = maFur.getNhrGuideObjects(nhrObject)
                    if nhrGuideObjects:
                        for nhrGuideObject in nhrGuideObjects:
                            nhrGuideObjectPath = maUtils._dcc_getNodFullpathNodepathStr(nhrGuideObject)
                            nhrGuideObjectShape = maUtils._dcc_getNodShapeNodepathStr(nhrGuideObject)
                            nhrGuideObjectName = maUtils._nodeString2nodename_(nhrGuideObject)
    ...
    def setCreateNurbsHairSolverConnection(self):
        ...
        if nurbsHairSolverObjects:
            for nurbsHairSolverObject in nurbsHairSolverObjects:
                currentGuideGroup = maUtils.getAttrDatum(nurbsHairSolverObject, prsOutputs.Util.astRigSolGuideSourceAttrLabel)
                if currentGuideGroup:
                    if maUtils._isAppExist(currentGuideGroup):
...
#
class IfAstGeneralToolUnit(kitQtWgtAbs.IfToolUnitBasic):
    UnitConnectLinks = [
        prsMethods.Asset.modelLinkName(),
        prsMethods.Asset.rigLinkName(),
        prsMethods.Asset.groomLinkName(),
    ...
    VAR_kit__qt_wgt__unit__uiname = 'General Tool Unit'
    ...
    dicAstUtils = {
        ...
        'variant': [0, 1, 0, 1, 2, 'Variant(s)'], 'importShader': [1, 1, 2, 1, 2, 'Import Nde_ShaderRef', 'svg_basic/python'],
        'usePath': [1, 3, 0, 1, 2, 'Use Path'], 'useName': [1, 3, 1, 1, 2, 'Use Name'], 'useGeom': [1, 3, 2, 1, 2, 'Use Nde_Geometry'],
        'loadMeshIndex': [1, 4, 0, 1, 4, 'Load Mesh Unique ID', 'svg_basic/load'],
        # 5
        'astUnitClearScene': [1, 6, 0, 1, 2, 'Clean Maya - Scene', 'svg_basic/python'], 'astUnitRenameScene': [1, 6, 2, 1, 2, 'Rename Maya - Scene', 'svg_basic/python'],
        # 7
        'loadRigAsset': [1, 8, 0, 1, 4, 'Load Asset ( Rig )', 'svg_basic/rig']
    }
    # Hierarchy
    dicUtilsHier = {
        0: 'Config(s)',
        ...
        2: 'Action(s)',
        'parentGroup': [0, 3, 0, 1, 3, ''], 'addObject': [1, 3, 3, 1, 1, 'Add Object', 'svg_basic/addtab'],
        'childGroup': [0, 4, 0, 1, 3, ''], 'addGroup': [1, 4, 3, 1, 1, 'Add Group', 'svg_basic/addtab'],
    ...
    def refreshMethod(self):
        if self.connectObject() is not None:
            ...
            #
            if prsMethods.Asset.isModelStageName(self.connectObject().assetStage):
                self._addObjectButton.setNameString('Add Nde_Geometry')
    ...
    def _setAstModelGraphTool(self, toolBox, buttonConfig, hierarchyDataFn):
        ...
        for seq, i in enumerate(buttonConfig):
            ...
            button.setNameString(explain)
            button.setIcon('svg_basic/addtab')
            x = seq % 2
            if x == 0:
                index += 1
            #
    ...
    def setupAstLightToolUiBox(self, toolBox):
        ...
        assetName = self.connectObject().assetName
        #
        self.connectLightToScaleButton = guiQtWidgets.QtPressbutton()
    ...
    def setupAstUtilsToolUiBox(self, toolBox):
        ...
        #
        self._cleanSceneButton = guiQtWidgets.QtPressbutton()
        ...
        #
        self._renameSceneButton = guiQtWidgets.QtPressbutton()
        ...
        #
        self._loadRigProductButton = guiQtWidgets.QtPressbutton()
    ...
    def setAstVariantUiLabelShow(self):
        ...
        if variantLis:
            ...
            self._astShaderVariantLabel.setChoose(prsOutputs.Util.astDefaultVersion)
        #
        self.setBtnState()
    #
    ...
    def _kit__unit__set_build_Widgets(self):
        ...
        #
        self._astModelSolClothHierToolUiBox = guiQtWidgets.QtToolbox()
        ...
        #
        self._astModelSolverHairGraphToolUiBox = guiQtWidgets.QtToolbox()
        ...
        #
        self.astLightHierToolUiBox = guiQtWidgets.QtToolbox()
        ...
        #
        self._astLightToolUiBox = guiQtWidgets.QtToolbox()
        ...
        #
        self._astUtilsToolUiBox = guiQtWidgets.QtToolbox()
...
#
class IfAstModelInfoToolUnit(kitQtWgtAbs.IfToolUnitBasic):
    UnitConnectLinks = [
        prsMethods.Asset.modelLinkName(),
        prsMethods.Asset.rigLinkName(),
        prsMethods.Asset.groomLinkName(),
    ...
    def setupGeometryQtTab(self, layout):
        self._astGeometryRadarChart = guiQtWidgets.QtRadarchart()
        layout.addWidget(self._astGeometryRadarChart)
        #
        self._astGeometrySectorChart = guiQtWidgets.QtSectorchart()
        layout.addWidget(self._astGeometrySectorChart)
    #
    def setupShaderQtTab(self, layout):
        self._astModelShaderRadarChart = guiQtWidgets.QtRadarchart()
        layout.addWidget(self._astModelShaderRadarChart)
        #
        self._astModelShaderSectorChart = guiQtWidgets.QtSectorchart()
    ...
    def _kit__unit__set_build_Widgets(self):
        ...
        # Nde_Geometry
        widget = qtCore.QWidget_()
        self._tabWidget.addTab(widget, 'Nde_Geometry', 'svg_basic/tab')
        layout = qtCore.QVBoxLayout_(widget)
        layout.setAlignment(qtCore.QtCore.Qt.AlignTop)
        self.setupGeometryQtTab(layout)
        # Nde_ShaderRef
        widget = qtCore.QWidget_()
        self._tabWidget.addTab(widget, 'Nde_ShaderRef', 'svg_basic/tab')
        layout = qtCore.QVBoxLayout_(widget)
        layout.setAlignment(qtCore.QtCore.Qt.AlignTop)
...
#
class IfAstUploadToolUnit(kitQtWgtAbs.IfToolUnitBasic):
    UnitConnectLinks = [
        prsMethods.Asset.modelLinkName(),
        prsMethods.Asset.rigLinkName(),
        prsMethods.Asset.groomLinkName(),
    ...
    # Asset
    dicAstCheck = {
        'mainCheck': [0, 0, 0, 1, 2, 'Main', 'svg_basic/info'], 'subCheck': [0, 0, 2, 1, 2, 'Sub', 'svg_basic/info']
    }
    #
    dicAstUpload = {
        0: 'Config(s)',
        ...
        5: 'Action(s)',
        'upload': [0, 6, 0, 1, 4, u'Upload ！！！', 'svg_basic/upload']
    }
    #
    dicAstModelExtend = {
        'updateSolverGeometry': [0, 0, 0, 1, 4, 'Update Solver Nde_Geometry', 'svg_basic/upload']
    }
    # Variant
    dicAstVariantModify = {
        'variant': [0, 0, 0, 1, 2, 'Variant'], 'setVariant': [0, 0, 2, 1, 2, 'Set Variant ( Material )', 'svg_basic/python']
    }
    def __init__(self, *args, **kwargs):
    ...
    def setupUploadTab(self, layout):
        self._astTipToolUiBox = guiQtWidgets.QtToolbox()
        layout.addWidget(self._astTipToolUiBox)
        self._astTipToolUiBox.setTitle('Tip & Note')
        #
        self._astSnapToolUiBox = guiQtWidgets.QtToolbox()
    ...
    def setupAstTipToolUiBox(self, toolBox):
        ...
        #
        self._tipTextBrower = guiQtWidgets.QtTextbrower()
        toolBox.setInfo(inData, 'tip', self._tipTextBrower)
        self._tipTextBrower.setEnterEnable(False)
        #
        self._noteTexBrower = guiQtWidgets.QtTextbrower()
    ...
    def setupAstUploadToolUiBox(self, toolBox):
        ...
        #
        self._astWithProductButton = guiQtWidgets.QtCheckbutton()
        ...
        #
        self._astWithAssemblyButton = guiQtWidgets.QtCheckbutton()
        toolBox.setButton(inData, 'withAssembly', self._astWithAssemblyButton)
        self._astWithAssemblyButton.setTooltip(
            u'''启用 / 关闭 上传 资产组装文件：\n1，启用 上传时会上传该项目。'''
        )
        #
        self._assemblyPercentLabel = guiQtWidgets.QtValueArrayLine()
        ...
        #
        self._astWithAnimationButton = guiQtWidgets.QtCheckbutton()
        ...
        #
        self._astFrameLabel = guiQtWidgets.QtValueArrayLine()
        ...
        #
        self._astWithAovButton = guiQtWidgets.QtCheckbutton()
        ...
        #
        self._astUploadButton = guiQtWidgets.QtPressbutton()
    ...
    def setupAstCheckToolUiBox(self, toolBox):
        ...
        #
        self._astMainCheckButton = guiQtWidgets.QtPressbutton()
        ...
        #
        self._astSubCheckButton = guiQtWidgets.QtPressbutton()
    ...
    def setupAstModelExtendToolUiBox(self, toolBox):
        ...
        #
        self._withSolverGeometryButton = guiQtWidgets.QtPressbutton()
    ...
    def setupAstVariantModifyToolUiBox(self, toolBox):
        ...
        #
        self._astVariantChangeLabel = guiQtWidgets.QtValueLine()
        ...
        #
        self._astVariantChangeButton = guiQtWidgets.QtPressbutton()
    ...
    def setAstVariantUiLabelShow(self):
        ...
        if chooseBox:
            ...
            if variants:
                ...
                chooseBox.setDatum(prsOutputs.Util.astDefaultVersion)
    #
    ...
    def setAstUpdateCheck(self):
        ...
        if bscMethods.OsFile.isExist(serverProductFile):
            ...
            localViewTime = maUtils.getAttrDatum(astUnitRootGroup, prsOutputs.Util.basicUpdateAttrLabel)
            #
    ...
    def _astRenderSnapshotCmd(self):
        ...
        renderPreview = directory + '/' + modelIndex + prsOutputs.Util.pngExt
        #
        renderer = prsMethods.Project.mayaRenderer(projectName)
        #
    ...
    def _initAstCheck(self):
        ...
        self._astUploadButton.setNameString(u'Upload {} ！！！'.format(
    ...
    def _updateAstUploadState(self):
        ...
        if isMeshChanged:
            if prsMethods.Asset.isModelStageName(assetStage):
                if assetVariant != prsOutputs.Util.astDefaultVersion:
                    isHide = True
    ...
    def _kit__unit__set_build_Widgets(self):
        ...
        #
        widget = qtCore.QWidget_()
        self._tabWidget.addTab(widget, 'Upload', 'svg_basic/tab')
        layout = qtCore.QVBoxLayout_(widget)
        layout.setAlignment(qtCore.QtCore.Qt.AlignTop)
