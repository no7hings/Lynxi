...
#
class IfScLightLinkToolUnit(kitQtWgtAbs.IfToolUnitBasic):
    projectName = currentProjectName
    # Utilities Tool
    dicScLightUtilsTool = bscMtdCore.orderedDict()
    dicScLightUtilsTool['sceneAssetManager'] = [0, 0, 0, 1, 4, 'Scene Compose', 'svg_basic/subwindow']
    ...
    def setScLightUtilsToolUiBox(self):
        ...
        #
        self.sceneAssetManagerButton = guiQtWidgets.QtPressbutton()
    ...
    def _kit__unit__set_build_(self):
        self.scLightUtilsToolUiBox = guiQtWidgets.QtToolbox()
...
class IfScMayaComposeToolUnit(kitQtWgtAbs.Abs_KitQtWgtUnit):
    ...
    dicScAstLoad = {
        0: 'Camera Unit(s)',
        'scLoadCameraUnit': [0, 1, 0, 1, 4, 'Load Camera Unit(s)', 'svg_basic/load'],
        2: 'Asset Unit(s)',
        'scLoadAssetUnit': [0, 3, 0, 1, 4, 'Load Asset Unit(s)', 'svg_basic/load'],
    }
    #
    dicScAstUpdate = {
        0: 'Cache Config(s)',
        ...
        3: 'Camera Cache(s)',
        'scUpdateCameraCache': [0, 4, 0, 1, 4, 'Update Camera Cache(s)', 'svg_basic/timerefresh'],
        5: 'Asset Cache(s)',
        'scUpdateAstModelCache': [0, 6, 0, 1, 2, 'Update Model Cache(s)', 'svg_basic/timerefresh'], 'scUpdateAstExtraCache': [0, 6, 2, 1, 2, 'Update Extra Cache(s)', 'svg_basic/timerefresh'],
        'scUpdateAstCfxFurCache': [0, 7, 0, 1, 4, 'Update Groom Fur Cache(s)', 'svg_basic/timerefresh'],
    }
    def __init__(self, *args, **kwargs):
    ...
    def setTreeViewBox(self):
        ...
        def setActionData():
            actions = [
                ('Basic', ),
                ('Refresh', 'svg_basic/refresh', True, self.setListSceneCompose),
                ('Extend', ),
                ('Select All', 'svg_basic/checkedall', True, treeBox.selectAll),
                ('Select Clear', 'svg_basic/uncheckedall', True, treeBox.clearSelection),
            ]
    ...
    def setupScLoadToolUiBox(self, toolBox):
        ...
        #
        self._scLoadCameraUnitButton = guiQtWidgets.QtPressbutton()
        ...
        #
        self._scLoadAssetUnitButton = guiQtWidgets.QtPressbutton()
    ...
    def setupScUpdateToolUiBox(self, toolBox):
        ...
        #
        self._scUpdateIgnoreNonExistsCheckbutton = guiQtWidgets.QtCheckbutton()
        ...
        #
        self._scUpdateIgnoreNonAnimationCheckbutton = guiQtWidgets.QtCheckbutton()
        ...
        #
        self._scUpdateIgnoreUnloadCheckbutton = guiQtWidgets.QtCheckbutton()
        ...
        # Camera Cache
        self._scUpdateCameraCacheButton = guiQtWidgets.QtPressbutton()
        ...
        # Model Cache
        self._scUpdateAstModelCacheButton = guiQtWidgets.QtPressbutton()
        ...
        # Cfx Fur Cache(s)
        self._scUpdateAstCfxCacheButton = guiQtWidgets.QtPressbutton()
        ...
        # Extra Cache
        self._updateScAstExtraCacheButton = guiQtWidgets.QtPressbutton()
...
class IfScOsComposeToolUnit(kitQtWgtAbs.Abs_KitQtWgtUnit):
    ...
    dicModifyTool = dict(
        ...
        collectionFile=[0, 1, 0, 1, 4, 'Collection File(s)', 'svg_basic/info']
    )
    def __init__(self, *args, **kwargs):
    ...
    def setupModifyToolUiBox(self, toolBox):
        ...
        #
        self._ignoreProjectButton = guiQtWidgets.QtCheckbutton()
        ...
        #
        self._scOsFileCollectionButton = guiQtWidgets.QtPressbutton()
...
#
class IfScAssetToolUnit(kitQtWgtAbs.IfToolUnitBasic):
    def __init__(self, *args, **kwargs):
    ...
    def setListAsset(self):
        def setBranch(key, value, assetNumberKeys):
            ...
            #
            astModelSectorChart = guiQtWidgets.QtSectorchart()
        ...
        def setActionData():
            ...
            def setRigLoadWindowShowCmd():
                IfToolWindow = guiQtWidgets.QtToolWindow(self)
            ...
            listBox.setActionData(
                [
                    ('Window',),
                    ('Rig Load Window', 'svg_basic/subwindow', True, setRigLoadWindowShowCmd),
                    ...
                    ('Action', ),
                    ('Upload Asset Cache', ('svg_basic/file', 'svg_basic/upload_action'), isScUploadAstCacheEnable, scAssetCacheUploadCmd)
