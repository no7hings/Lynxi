...
#
class IfSceneryProductToolWindow(guiQtWidgets.QtToolWindow):
    widthSet = 400
    ...
    def setScnTopToolBar(self, layout):
        self._filterButton = guiQtWidgets.QtIconbutton('svg_basic/filter')
    ...
    def setScnRightToolBox(self):
        ...
        for i in uiData:
            toggleButton, iconKeywordStr, uiTip, visible, commands = i
            toggleButton.setIconExplain(iconKeywordStr, 32, 32)
            if visible is False:
                toggleButton.hide()
            if commands:
