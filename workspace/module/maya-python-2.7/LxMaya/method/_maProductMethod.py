                ...
                for nodePath in nodeLis:
                    if cls.mtd_app_node._isAppExist(nodePath):
                        ...
                        if nodeName.startswith(prsMethods.Product.modulePrefixname(moduleString)):
                            ...
                            #
                            unitIndex, typepathString, unitName, unitVariant, unitStage = unitDatum
                            if typepathString in prsMethods.Product.moduleCategoryNames(moduleString):
                                lis.append(
                                    (unitIndex, typepathString, unitName, unitVariant, unitStage)
                                )
        return lis
    @classmethod
