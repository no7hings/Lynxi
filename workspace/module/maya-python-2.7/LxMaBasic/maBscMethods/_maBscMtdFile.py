...
class File(maBscMtdCore.Mtd_MaBasic):
    ...
    def exportSelectedTo(cls, fileString, nodepathString, withHistory=False):
        maBscMtdCore.Mtd_MaFile._setMaFileExportSelected(fileString, nodepathString, withHistory)

    @classmethod
    def exportSelectedWithSetTo(cls, fileString, nodepathString, setString, withHistory=False):
        maBscMtdCore.Mtd_MaFile._setMaFileExportSelectedWithSet(fileString, nodepathString, setString, withHistory)
...
class Texture(object):
    ...
    def existFiles(cls, fileString):
        if bscMethods.OsFile.isExist(fileString):
            return [fileString.replace('\\', bscMethods.OsPath.DEF_bsc__os__pathsep)]
