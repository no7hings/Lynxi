...
def _toLxOsIconFile_(iconKeywordStr, ext=u'.png'):
    isMayaIcon = iconKeywordStr.startswith('maya')
    #
    subLabelString = 'table'
    #
    if iconKeywordStr:
        if '#' in iconKeywordStr:
            subLabelString = iconKeywordStr.split('#')[0]
            iconKeywordStr = iconKeywordStr.split('#')[-1]
        ...
        iconKeywordStr = none
    #
    fileString_ = '{}/{}/{}{}'.format(iconRoot(), subLabelString, iconKeywordStr, ext)
    #
    if isMayaIcon:
