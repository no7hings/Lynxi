...
class MtdUtilityBasic(prsConfigure.Utility):
    ...
    def _VAR_datum_set_project_maya_shelf(cls):
        ...
        dic['assetManagerTool'] = [
            ...
            [
                ...
                ['toolCommand',
                 'from LxInterface.qt.ifWidgets import ifProductWindow;w=ifProductWindow.If_QtAssetManagerWindow();w.windowShow()'],
                #
                ...
                ['helpCommand',
                 'from LxInterface.qt.ifWidgets import ifProductWindow;w=ifProductWindow.If_QtAssetManagerWindow();w.helpShow()']
            ]
        ]
        ...
        dic['assetUtilitiesTool'] = [
            ...
            [
                ...
                ['helpCommand',
                 'from LxInterface.qt.ifWidgets import ifProductWindow;w=ifProductWindow.QtIf_ToolkitWindow();w.helpShow()']
            ]
        ]
        dic['assetPresetTool'] = [
            None,
        ...
        dic['sceneryManagerTool'] = [
            ...
            [
                ...
                ['toolCommand',
                 'from LxInterface.qt.ifWidgets import ifProductWindow;w=ifProductWindow.If_QtSceneryManagerWindow();w.windowShow()'],
                #
                ...
                ['helpCommand',
                 'from LxInterface.qt.ifWidgets import ifProductWindow;w=ifProductWindow.If_QtSceneryManagerWindow();w.helpShow()']
            ]
        ]
        ...
        dic['sceneManagerTool'] = [
            ...
            [
                ...
                ['toolCommand',
                 'from LxInterface.qt.ifWidgets import ifProductWindow;w=ifProductWindow.If_QtSceneManagerWindow();w.windowShow()'],
                #
                ...
                ['helpCommand',
                 'from LxInterface.qt.ifWidgets import ifProductWindow;w=ifProductWindow.If_QtSceneManagerWindow();w.helpShow()']
            ]
        ]
...
class MtdProductBasic(prsConfigure.Product):
    @classmethod
    def moduleNames(cls):
    ...
    def lxDbProductUnitDefaultSetConfig(cls, projectString, moduleString, number):
        ...
        lis = [
            ...
            [(cls.VAR_product_key_Variant, u'变体 [ Variant(s) ]'), (bscConfigure.Utility.DEF_Value_Default,)],
...
class MtdAssetBasic(prsConfigure.Product):
    @classmethod
    def prefix(cls):
    ...
    @classmethod
    def categoryShowname(cls, categoryString):
...
class MtdSceneryBasic(prsConfigure.Product):
    @classmethod
    def prefix(cls):
...
class MtdSceneBasic(prsConfigure.Product):
    @classmethod
    def prefix(cls):
