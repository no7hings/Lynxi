...
# Basic Item
class Abc_QtItem(qtCore.QWidget):
    ...
    #
    def setupUi(self):
        self._itemModel = qtModelAbstract._QtItemModel(self)


# Basic View
class Abc_QtView(qtCore.QWidget):
    clicked = qtCore.uiSignal()
    ...
    #
    def setupUi(self):
        self._viewModel = qtModelAbstract._QtViewModel(self)


# Window Basic
class Abc_QtWindow(qtCore.QMainWindow):
    ...
    def setupUi(self):
        ...
        #
        self._menuButton = QtIconbutton('svg_basic@svg#menu', self)
        self._menuButton.setPressable(False)
        #
        self._closeButton = QtIconbutton('svg_basic@svg#close', self)
        self._closeButton.setTooltip(u'关闭窗口\nClose Window')
        #
        self._maximizeButton = QtIconbutton('svg_basic@svg#maximize', self)
        self._maximizeButton.hide()
        self._maximizeButton.setTooltip(u'最大化 / 正常化窗口\nMaximized / Normalize Window')
        #
        self._minimizeButton = QtIconbutton('svg_basic@svg#minimize', self)
        self._minimizeButton.hide()
        self._minimizeButton.setTooltip(u'最小化 / 正常化窗口\nMinimized / Normalize Window')
        #
        self._expandButton = QtIconbutton('svg_basic@svg#fold', self)
        self._expandButton.hide()
        self._expandButton.setTooltip(u'点击展开 / 收起主面板\nExpand / Contract Window')
        #
        self._helpButton = QtIconbutton('svg_basic@svg#help', self)
        self._helpButton.hide()
        #
        self._confirmButton = QtIconbutton('svg_basic@svg#confirm', self)
        ...
        #
        self._cancelButton = QtIconbutton('svg_basic@svg#cancel', self)
        ...
        #
        self._viewModel = qtModelAbstract.QtWindowModel(self)
        #
...
#
class _QtSeparateWindow(Abc_QtWindow):
...
#
class Abc_QtChart(qtCore.QWidget):
...
#
class Abc_QtTreeviewItem(Abc_QtItem):
    ...
    #
    def setupUi(self):
        self._itemModel = qtModelAbstract.QtTreeviewItemModel(self)


# Scroll Bar
class QtScrollBar(qtCore.QWidget):
    ...
    def setupUi(self):
        self._menuButton = QtIconbutton('svg_basic@svg#menu', self)
        self._subScrollButton = QtIconbutton('svg_basic@svg#vScrollSub', self)
        self._subScrollButton.setTooltip(u'''单击：向上翻页\n按住：向上滚动''')
        self._addScrollButton = QtIconbutton('svg_basic@svg#vScrollAdd', self)
        self._addScrollButton.setTooltip(u'''单击：向下翻页\n按住：向下滚动''')
        self._tooltipWidget = qtCore.QtTooltipWidget_(self)
        #
        self._viewModel = qtModelAbstract.QtScrollBarModel(self)


#
class Abc_QtIconbutton(Abc_QtItem):
    ...
    #
    def setupUi(self):
        self._itemModel = qtModelAbstract.QtIconbuttonModel(self)
        #
        self.actionData = []


#
class QtIconbutton(Abc_QtIconbutton):
...
#
class Abc_QtMenuIconbutton(Abc_QtItem):
    @qtCore.uiTooltipClearMethod
    def mousePressEvent(self, event):
        if event.button() == QtCore.Qt.LeftButton:
            self.itemModel()._pressStartAction(event)
...
#
class QtMenuIconbutton(Abc_QtMenuIconbutton):
    def __init__(self, iconKeyword=None, *args, **kwargs):
        self.clsSuper = super(qtCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
...
#
class Abc_QtValueEnterlabel(qtCore.QWidget):
    def _initItemBasic(self):
        self.setSizePolicy(
    ...
    #
    def setupUi(self):
        self._itemModel = qtModelAbstract.QtValueEnterItemModel(self)
        self._itemModel.setEnterWidgetClass(QLineEdit_)


#
class Abc_QtFilterEnterlabel(qtCore.QWidget):
    entryChanged = qtCore.uiSignal()
    def _initItemBasic(self):
        self.setSizePolicy(
    ...
    def readHistory(self):
        filterHistoryFile = lxCore_.UserPreset().uiFilterHistoryFile()
    ...
    #
    def setupUi(self):
        self._historyButton = QtIconbutton('svg_basic@svg#search')
        ...
        # Copy
        self._copyButton = QtIconbutton('svg_basic@svg#copy')
        ...
        #
        self._clearButton = QtIconbutton('svg_basic@svg#clear')
        self._clearButton.setParent(self)
        self._clearButton.hide()
        #
        self._itemModel = qtModelAbstract.QtFilterEnterItemModel(self)
        #
...
#
class QtFilterEnterlabel(Abc_QtFilterEnterlabel):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(qtCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
...
#
class Abc_QtEnterlabel(Abc_QtItem):
    entryChanged = qtCore.uiSignal()
    ...
    #
    def setupUi(self):
        self._chooseButton = QtIconbutton('svg_basic@svg#choose', self)
        self._chooseButton.clicked.connect(self._chooseDropAction)
        self._chooseButton.setTooltip(
            u'1.左键点击：查看/选择更多选项\r\n2.中键滚动：向上/向下选择'
        )
        #
        self._entryButton = QtIconbutton('svg_basic@svg#edit', self)
        ...
        #
        self._itemModel = qtModelAbstract.QtEnterItemModel(self)
        #
...
#
class _QtChooseItem(Abc_QtItem):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(qtCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
...
#
class _QtChooseView(Abc_QtView):
    def __init__(self, *args, **kwargs):
    ...
    def setupUi(self):
        ...
        #
        self._viewModel = qtModelAbstract.QtChooseViewModel(self)
...
class _QtChooseDropView(qtCore.QWidget):
    ...
    def setupUi(self):
        ...
        #
        self._separateButton = QtIconbutton('svg_basic@svg#unpinWindow', self)
        self._separateButton.hide()
        #
        self._filterViewWidget = QtFilterEnterlabel(self)
        self._filterViewWidget.hide()
        #
        self._viewModel = qtModelAbstract.QtChooseDropViewModel(self, _QtChooseItem)
...
class _QtActionItem(qtCore.QWidget):
    ...
    #
    def setupUi(self):
        self._extendButton = QtIconbutton('svg_basic@svg#subWindow', self)
        self._extendButton.hide()
        #
        self._itemModel = qtModelAbstract.QtActionItemModel(self)
...
class _QtActionDropView(qtCore.QWidget):
    ...
    #
    def setupUi(self):
        self._separateButton = QtIconbutton('svg_basic@svg#unpin_', self)
        self._separateButton.hide()
        #
        self._vScrollBar = None
        #
        self._viewModel = qtModelAbstract.QtActionDropViewModel(self, _QtActionItem)


#
class QtAttributeItem(Abc_QtItem):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(qtCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
    ...
    #
    def setupUi(self):
        self._itemModel = qtModelAbstract.QtAttributeItemModel(self)


#
class _QtTabBasic(qtCore.QWidget):
    clicked = qtCore.uiSignal()
    ...
    #
    def setupUi(self):
        self._menuButton = QtMenuIconbutton('svg_basic@svg#tabMenu_v', self)
        self._menuButton.setPressable(False)
        self._menuButton.setTooltip(
            u'''点击显示更多操作'''
        )
        #
        self._closeButton = QtIconbutton(parent=self)
        self._closeButton.hide()
        self._closeButton.setIcon('svg_basic@svg#closeTab', 8, 8, 10, 10)
        #
        self._itemModel = qtModelAbstract.QtTabModel(self)


#
class QtButtonTab(_QtTabBasic):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(qtCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
    ...
    #
    def setupUi(self):
        self._menuButton = QtMenuIconbutton('svg_basic@svg#menu_tab_v', self)
        self._menuButton.setPressable(False)
        self._menuButton.setTooltip(
            u'''点击显示更多操作'''
        )
        ...
        self._closeButton.setIcon('svg_basic@svg#closeTab', 8, 8, 10, 10)
        #
        self._itemModel = qtModelAbstract.QtButtonTabModel(self)


# Tab
class QtShelfTab(_QtTabBasic):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(qtCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
    ...
    #
    def setupUi(self):
        self._menuButton = QtMenuIconbutton('svg_basic@svg#menu_d', self)
        self._menuButton.setPressable(False)
        self._menuButton.setTooltip(
            u'''点击显示更多操作'''
        )
        ...
        self._closeButton.setIcon('svg_basic@svg#closeTab', 8, 8, 10, 10)
        #
        self._itemModel = qtModelAbstract.QtShelfTabModel(self)


# Choose Tab
class QtChooseTab(qtCore.QWidget):
    chooseChanged = qtCore.uiSignal()
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(QtChooseTab, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
        self._initItemBasic()
        #
    ...
    def setupUi(self):
        ...
        self._chooseButton.clicked.connect(self._chooseDropAction)
        #
        self._itemModel = qtModelAbstract.QtChooseTabModel(self)
        #
        self._chooseButton.upScrolled.connect(self._itemModel._chooseScrollUpAction)
        self._chooseButton.downScrolled.connect(self._itemModel._chooseScrollDownAction)
...
#
class Abc_QtTabBar(qtCore.QWidget):
    # Scroll
    valueChanged = qtCore.uiSignal()
    stop = qtCore.uiSignal()
    # Click
    ...
    #
    def setupUi(self):
        self._viewModel = qtModelAbstract.QtTabBarModel(self)


#
class _QtTabBar(Abc_QtTabBar):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(qtCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
...
# Tab View
class Abc_QtTabGroup(qtCore.QWidget):
    currentChanged = qtCore.uiSignal()
    ...
    def setupUi(self):
        ...
        #
        self._viewModel = qtModelAbstract.QtTabGroupModel(self)


# Group
class Abc_QtGroup(qtCore.QWidget):
    expanded = qtCore.uiSignal()
    ...
    #
    def setupUi(self):
        self._menuButton = QtMenuIconbutton('svg_basic@svg#tabMenu_h', self)
        self._menuButton.setTooltip(
            u'''点击显示更多操作'''
        )
        self._groupModel = qtModelAbstract.QtGroupModel(self)


#
class Abc_QtTextBrower(qtCore.QWidget):
    entryChanged = qtCore.uiSignal()
    #
    counterWidth = 32
    menuHeight = 24
    ...
    def setupUi(self):
        ...
        #
        self._itemModel = qtModelAbstract.QtTextBrowerItemModel(self)
        #
...
#
class QtTextBrower(Abc_QtTextBrower):
    def __init__(self, *args, **kwargs):
        self.clsSuper = super(qtCore.QWidget, self)
        self.clsSuper.__init__(*args, **kwargs)
        #
