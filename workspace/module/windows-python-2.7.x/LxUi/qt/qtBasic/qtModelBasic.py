...
#
class _QtScrollAreaModelBasic(qtAbstract.QtScrollAreaModelAbs):
...
#
class _QtItemModel(_QtItemModelBasic):
    def __init__(self, widget):
        self._initItemModelBasic(widget)


#
class _QtViewModel(_QtViewModelBasic):
    def __init__(self, widget):
        self._initViewModelBasic(widget)


#
class QtTreeviewItemModel(_QtItemModelBasic):
    def __init__(self, widget):
        self._initItemModelBasic(widget)
...
#
class QtEnterItemModel(_QtItemModelBasic):
    def __init__(self, widget):
        self._initItemModelBasic(widget)
        #
        self.__overrideAttr()
...
#
class _QtTabModelBasic(qtAbstract.QtTabItemModelAbs):
...
#
class QtTabModel(_QtTabModelBasic):
    def __init__(self, widget):
        self._initTabModelBasic(widget)


#
class QtButtonTabModel(_QtTabModelBasic):
    def __init__(self, widget):
        self._initTabModelBasic(widget)
    #
...
# Tab Item
class QtShelfTabModel(_QtTabModelBasic):
    def __init__(self, widget):
        self._initTabModelBasic(widget)
    #
    def _updateRectGeometry(self):
...
#
class _QtTabBarModelBasic(qtAbstract.QtTabBarModelAbs):
...
# Tab Bar
class QtTabBarModel(_QtTabBarModelBasic):
    def __init__(self, widget):
        self._initTabBarModelBasic(widget)


#
class _QtTabGroupModelBasic(qtAbstract.QtTabViewModelAbs):
...
# Tab View
class QtTabGroupModel(_QtTabGroupModelBasic):
    def __init__(self, widget):
...
# Action Item
class QtActionItemModel(_QtItemModelBasic):
    def __init__(self, widget):
        self._initItemModelBasic(widget)
        #
        self.__overrideAttr()
...
# Choose View
class QtChooseViewModel(_QtViewModelBasic):
    def __init__(self, widget):
        self._initViewModelBasic(widget)
        #
...
# Icon Button
class QtIconbuttonModel(_QtItemModelBasic):
    def __init__(self, widget):
        self._initItemModelBasic(widget)
        #
        self.__overrideAttr()
...
# Press Button
class QtPressbuttonModel(_QtItemModelBasic):
    def __init__(self, widget):
        self._initItemModelBasic(widget)
        #
        self.__overrideAttr()
...
# Attribute Item
class QtAttributeItemModel(_QtItemModelBasic):
    def __init__(self, widget):
        self._initItemModelBasic(widget)
        #
        self.__overrideAttr()
...
#
class QtChartModelBasic(qtAbstract.QtChartModelAbs):
    _angle = math.radians
    _sin = math.sin
    _cos = math.cos
    _tan = math.tan
...
#
class _QtGroupModelBasic(qtAbstract.QtGroupModelAbs):
...
#
class QtGroupModel(_QtGroupModelBasic):
    def __init__(self, widget):
