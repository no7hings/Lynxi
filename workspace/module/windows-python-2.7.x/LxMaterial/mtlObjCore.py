...
class Abc_MtlGeometryProperty(Abc_MtlAttribute):
    def _initAbcMtlGeometryProperty(self, *args):
        self._initAbcMtlAttribute(*args)


class Abc_MtlGeometryVisibility(Abc_MtlAttribute):
...
class Abc_MtlNodeDef(Abc_MtlDef):
