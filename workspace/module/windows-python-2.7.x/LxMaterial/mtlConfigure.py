...
Separator_String_Namespace = u':'

Value_Type_Closure = u'closure'

Value_Type_Boolean = u'boolean'
Value_Type_Integer = u'integer'
Value_Type_Integer_Array = u'integerarray'
Value_Type_Float = u'float'
Value_Type_Float_Array = u'floatarray'

Value_Type_Color2 = u'color2'
Value_Type_Color2_Array = u'color2array'
Value_Type_Color3 = u'color3'
Value_Type_Color3_Array = u'color3array'
Value_Type_Color4 = u'color4'
Value_Type_Color4_Array = u'color4array'

Value_Type_Vector2 = u'vector2'
Value_Type_Vector2_Array = u'vector2array'
Value_Type_Vector3 = u'vector3'
Value_Type_Vector3_Array = u'vector3array'
Value_Type_Vector4 = u'vector4'
Value_Type_Vector4_Array = u'vector4array'

Value_Type_Matrix33 = u'matrix33'
Value_Type_Matrix44 = u'matrix44'

Value_Type_String = u'string'
Value_Type_String_Array = u'stringarray'
Value_Type_FileName = u'filename'
