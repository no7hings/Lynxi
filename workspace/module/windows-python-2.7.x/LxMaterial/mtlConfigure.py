...
class Utility(object):
    ...
    DEF_mtl_key_custom_port = u'custom_port'
    ...
    DEF_mtl_key_target_port = u'target_port'
    DEF_mtl_key_target_category = u'target_category'
    DEF_mtl_key_target_portname = u'target_portname'
    ...
    DEF_mtl_porttype_integer_array = u'integerarray'
    DEF_mtl_porttype_float = u'float'
    DEF_mtl_porttype_float_array = u'floatarray'

    DEF_mtl_porttype_color2 = u'color2'
    DEF_mtl_porttype_color2_array = u'color2array'
    DEF_mtl_porttype_color3 = u'color3'
    DEF_mtl_porttype_color3_array = u'color3array'
    DEF_mtl_porttype_color4 = u'color4'
    DEF_mtl_porttype_color4_array = u'color4array'

    DEF_mtl_porttype_vector2 = u'vector2'
    DEF_mtl_porttype_vector2_array = u'vector2array'
    DEF_mtl_porttype_vector3 = u'vector3'
    DEF_mtl_porttype_vector3_array = u'vector3array'
    DEF_mtl_porttype_vector4 = u'vector4'
    DEF_mtl_porttype_vector4_array = u'vector4array'

    DEF_mtl_porttype_matrix33 = u'matrix33'
    DEF_mtl_porttype_matrix44 = u'matrix44'

    DEF_mtl_porttype_string = u'string'
    DEF_mtl_porttype_string_array = u'stringarray'
    DEF_mtl_porttype_file_name = u'filename'
    DEF_mtl_porttype_geometry_name = u'geomname'
    DEF_mtl_porttype_geometry_name_array = u'geomnamearray'
    ...
    DEF_mtl_maya_arnold_custom_def_file = os.path.dirname(__file__) + '/.data/maya_2019-arnold_5.4.0.1-custom_defs.json'
