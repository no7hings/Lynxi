...
def setupPipeline(projectName):
    ...
    #
    from LxCore.setup import appSetup, maSetup, maPush
    # Step >>>> 01
    appSetup.setBasicPythonPackageSetup()
    mayaVersion = projectPr.getProjectMayaVersion(projectName)
    maSetup.setMaPipelineEnvironSetup(mayaVersion)
    # Step >>>> 02
    # maPush.setMaCustomPlugPushCmd(projectName=projectName)


#
def setup(mayaVersion):
