...
def initializePlugin(obj):
    ...
    try:
        ...
        sys.stderr.write('Failed to Register Node: %s' % curveToMesh.nodeName)
        raise
    try:
        plug.registerNode(
        ...
        sys.stderr.write('Failed to Register Node: %s' % meshToSurface.nodeName)
        raise
...
def uninitializePlugin(obj):
    ...
    try:
        ...
        sys.stderr.write('Failed to Deregister Node: %s' % curveToMesh.nodeName)
        raise
    try:
        plug.deregisterNode(
            meshToSurface.typeId
        ...
        sys.stderr.write('Failed to Deregister Node: %s' % meshToSurface.nodeName)
        raise
